...
items = [ar1, ar2, sa1, sb1, sc1, sa2, sb2, sc2, sa3, sb3, sa4, sb4, sc4, sd4, sa5, sb5,
        a1, b1, c1, a2, b2, c2, d1, d2, d3, d4, d5]
...
def know_sa1():
    ...
    if check_parallel(sa1, ['sc2']):
        if check_parallel(sa2, ['sc1']):
            equal(b1, 'b2')
        if check_parallel(sb2, ['sb1']):
            equal(c1, 'a2')
